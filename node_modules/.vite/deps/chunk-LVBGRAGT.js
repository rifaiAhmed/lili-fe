...
var _excluded = ["value"];
var _excluded2 = ["className", "defaultValue", "disabled", "emptyIcon", "emptyLabelText", "getLabelText", "highlightSelectedOnly", "icon", "IconContainerComponent", "max", "name", "onChange", "onChangeActive", "onMouseLeave", "onMouseMove", "precision", "readOnly", "size", "value"];
...
function IconContainer(props) {
  ...
  return (0, import_jsx_runtime3.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime3.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime4.jsxs)(React3.Fragment, {
    children: [(0, import_jsx_runtime4.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
...
var Rating = React3.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(RatingRoot, _extends({
    ref: handleRef,
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime3.jsx)(RatingDecimal, {
          ...
          children: items.map(($, indexDecimal) => {
            ...
            return (0, import_jsx_runtime3.jsx)(RatingItem, _extends({}, ratingItemProps, {
    ...
    }), !readOnly && !disabled && (0, import_jsx_runtime4.jsxs)(RatingLabel, {
...
//# sourceMappingURL=chunk-LVBGRAGT.js.map
