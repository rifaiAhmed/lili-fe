...
var _excluded22 = ["autoFocus", "children", "className", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant", "slots", "slotProps"];
var RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
...
var Menu = React3.forwardRef(function Menu2(inProps, ref) {
  ...
  const menuListActionsRef = React3.useRef(null);
  ...
  return (0, import_jsx_runtime3.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime3.jsx)(MenuMenuList, _extends({
...
var Select = React6.forwardRef(function Select2(inProps, ref) {
  ...
  const restOfClasses = _objectWithoutPropertiesLoose(classes, _excluded23);
  const InputComponent = input || {
    standard: (0, import_jsx_runtime8.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime8.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime8.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime8.jsx)(React6.Fragment, {
    children: React6.cloneElement(InputComponent, _extends({
...
//# sourceMappingURL=chunk-MZ7MOQ2B.js.map
